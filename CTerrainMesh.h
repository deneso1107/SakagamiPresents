...
public:
     ...
     *
     * @param rayOrigin レイの開始点
     * @param rayDir レイの方向ベクトル
     * @param v0,v1,v2 三角形の3頂点
     * @param distance 交差点までの距離（出力）
     * @param hitPoint 交差点の座標（出力）
     * @return 交差した場合true
     */
    ...
    //    Vector3 rayOrigin = Vector3(localPosition.x, localPosition.y + 1000.0f, localPosition.z);
    //    Vector3 rayDir = Vector3(0.0f, -1.0f, 0.0f);
